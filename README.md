...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->484<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| thinkingmachines/inkling-small | upstage/solar-pro-3 | cognitivecomputations/dolphin-mistral-24b-venice-edition | microsoft/wizardlm-2-8x22b |
