...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->608<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| | | | |
|---|---|---|---|
| aion-labs/aion-3.5 | aion-labs/aion-3.5-mini | aion-labs/aion-2.0 | aion-labs/aion-3.0 |
| aion-labs/aion-3.0-mini | aion-labs/aion-rp-llama-3.1-8b | amazon/nova-2-lite-v1 | amazon/nova-lite-v1 |
| amazon/nova-micro-v1 | amazon/nova-premier-v1 | amazon/nova-pro-v1 | anthropic/claude-3-haiku |
| anthropic/claude-fable-5 | anthropic/claude-fable-5:batch | anthropic/claude-fable-5.1 | anthropic/claude-fable-5.1:batch |
| ~anthropic/claude-fable-latest | anthropic/claude-haiku-4.5 | anthropic/claude-haiku-4.5:batch | ~anthropic/claude-haiku-latest |
...
| anthropic/claude-opus-5.5 | anthropic/claude-opus-5.5:batch | ~anthropic/claude-opus-latest | anthropic/claude-sonnet-4 |
...
| cohere/command-a-plus | cohere/command-r-08-2024 | cohere/command-r-plus-08-2024 | cohere/command-r7b-12-2024 |
...
| deepseek/deepseek-v3.2-exp | deepseek/deepseek-v4-flash | deepseek/deepseek-v4-flash-0731 | ~deepseek/deepseek-v4-flash-latest |
| deepseek/deepseek-v4-flash-vision-exp | deepseek/deepseek-v4-pro | deepseek/deepseek-v4-pro-0813 | deepseek/deepseek-v4.1-flash |
| deepseek/deepseek-v4.1-flash:batch | deepseek/deepseek-r1 | deepseek/deepseek-r1-0528 | deepseek/deepseek-r1-distill-llama-70b |
| dots-studio/dots-3-note-preview:free | fireworks/ember-1 | openrouter/free | google/gemini-2.5-flash |
...
| inclusionai/ling-3.0-flash-fin:free | inclusionai/ling-3.0-flash-sante:free | inclusionai/ling-3.0-flash-vl | inference-net/schematron-v2-small |
| inference-net/schematron-v2-turbo | kwaipilot/kat-coder-pro-v2.5 | liquid/lfm-2.5-2.6b:free | anthracite-org/magnum-v4-72b |
...
| meta-llama/llama-4-scout | meta-llama/llama-guard-4-12b | meta/muse-glimmer-30b | meta/muse-spark-1.1 |
...
| openai/gpt-6-astra-pro | openai/gpt-6-astra-pro:batch | openai/gpt-6-luna | openai/gpt-6-luna:batch |
| openai/gpt-6-luna-pro | openai/gpt-6-luna-pro:batch | openai/gpt-6-sol | openai/gpt-6-sol:batch |
| openai/gpt-6-sol-pro | openai/gpt-6-sol-pro:batch | openai/gpt-oss-120b | openai/gpt-oss-120b:batch |
...
| qwen/qwen3.7-plus | qwen/qwen3.8-2.4t-a95b | qwen/qwen3.8-27b | qwen/qwen3.8-27b:free |
| qwen/qwen3.8-flash | qwen/qwen3.8-max-0902 | qwen/qwen3.8-max-prime | qwen/qwen3.8-omni-flash |
...
| sao10k/l3.1-euryale-70b | sao10k/l3.3-euryale-70b | stealth/space-bunny-alpha | x-ai/grok-4.20 |
...
| thinkingmachines/inkling:free | thinkingmachines/inkling-small | thinkingmachines/inkling-small:free | upstage/solar-mini4 |
...
| xiaomi/mimo-v2.6-flash | xiaomi/mimo-v2.6-pro | xiaomi/mimo-v2.6-pro-ultraspeed | z-ai/glm-4.5 |
| z-ai/glm-4.5-air | z-ai/glm-4.5v | z-ai/glm-4.6 | z-ai/glm-4.6v |
| z-ai/glm-4.7 | z-ai/glm-4.7-flash | z-ai/glm-5 | z-ai/glm-5-turbo |
| z-ai/glm-5.1 | z-ai/glm-5.2 | z-ai/glm-5.2:free | z-ai/glm-5.3 |
| z-ai/glm-5.3:batch | z-ai/glm-5.3-flash | z-ai/glm-5.3-flash:batch | z-ai/glm-5.3-flashx |
| z-ai/glm-5.3-prime | z-ai/glm-5v-turbo | ~z-ai/glm-flash-latest | ~z-ai/glm-latest |
