...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->539<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| ibm-granite/granite-4.0-h-micro | ibm-granite/granite-4.1-8b | inception/mercury-2 | inclusionai/ling-2.6-1t:free |
