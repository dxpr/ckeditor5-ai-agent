...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->521<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| deepseek/deepseek-v4-flash:free | deepseek/deepseek-v4-pro | deepseek/deepseek-r1 | deepseek/deepseek-r1-0528 |
...
| qwen/qwen3.7-max | qwen/qwen-2.5-72b-instruct | qwen/qwen-2.5-coder-32b-instruct | rekaai/reka-edge |
