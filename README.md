...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->592<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| openai/o4-mini:batch | openai/o4-mini-high | openrouter/fusion | unbiased/pareto |
...
| poolside/laguna-s-2.1:free | poolside/laguna-xs-2.1 | poolside/laguna-xs-2.1:free | prism-ml/ternary-bonsai-2-27b |
