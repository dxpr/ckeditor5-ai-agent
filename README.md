...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->554<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| nvidia/nemotron-3.5-lightning | nvidia/nemotron-3.5-lightning:free | nvidia/nemotron-nano-12b-v2-vl:free | nvidia/nemotron-nano-9b-v2:free |
