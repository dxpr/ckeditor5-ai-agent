...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->538<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| mistralai/mistral-medium-3 | mistralai/mistral-medium-3.1 | mistralai/mistral-nemo | mistralai/mistral-small-24b-instruct-2501 |
