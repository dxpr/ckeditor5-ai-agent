...
| nvidia/nemotron-3.5-lightning | nvidia/nemotron-3.5-lightning:free | ~openai/gpt-astra-latest | ~openai/gpt-luna-latest |
| ~openai/gpt-mini-latest | ~openai/gpt-sol-latest | ~openai/gpt-terra-latest | openai/gpt-audio |
