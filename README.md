...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->474<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| anthropic/claude-sonnet-4.6 | arcee-ai/coder-large | arcee-ai/trinity-large-thinking | arcee-ai/trinity-mini |
| arcee-ai/virtuoso-large | openrouter/auto | baidu/ernie-4.5-vl-424b-a47b | openrouter/bodybuilder |
...
| google/gemini-2.5-flash-image | google/gemini-3.1-flash-image-preview | google/gemini-3.1-flash-image | google/gemini-3-pro-image-preview |
...
| morph/morph-v3-large | gryphe/mythomax-l2-13b | nex-agi/nex-n2-pro | nousresearch/hermes-3-llama-3.1-405b |
...
| openrouter/owl-alpha | openrouter/pareto-code | perceptron/perceptron-mk1 | perplexity/sonar |
