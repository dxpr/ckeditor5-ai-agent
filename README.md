...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->499<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| inflection/inflection-3-productivity | kwaipilot/kat-coder-pro-v2 | liquid/lfm-2.5-1.2b-instruct:free | liquid/lfm-2.5-1.2b-thinking:free |
| anthracite-org/magnum-v4-72b | mancer/weaver | meta-llama/llama-3-8b-instruct | meta-llama/llama-3.1-70b-instruct |
...
| moonshotai/kimi-k2.7-code | morph/morph-v3-fast | morph/morph-v3-large | gryphe/mythomax-l2-13b |
...
| openai/gpt-5.6-terra-pro | openai/gpt-oss-120b | openai/gpt-oss-120b:free | openai/gpt-oss-20b |
