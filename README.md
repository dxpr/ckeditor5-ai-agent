...
🤖 Natively supports <!-- BEGIN_MODEL_COUNT -->555<!-- END_MODEL_COUNT --> models, with additional support for any self-hosted model via Ollama.
...
| nvidia/nemotron-3-ultra-550b-a55b:batch | nvidia/nemotron-3-ultra-550b-a55b:free | nvidia/nemotron-3.5-content-safety:free | nvidia/nemotron-3.5-lightning |
| nvidia/nemotron-3.5-lightning:free | nvidia/nemotron-nano-12b-v2-vl:free | nvidia/nemotron-nano-9b-v2:free | ~openai/gpt-latest |
...
| openai/gpt-5:batch | openai/gpt-5-codex:batch | openai/gpt-5-image | openai/gpt-5-image-mini |
...
| openai/gpt-5.6-terra:batch | openai/gpt-5.6-terra-pro | openai/gpt-5.6-terra-pro:batch | openai/gpt-oss-120b |
...
| qwen/qwen3.7-plus | qwen/qwen3.8-2.4t-a95b | qwen/qwen3.8-27b | qwen/qwen3.8-max |
